...
<Cards>
  <Cards.Card
    ...
    href="/interview-ready/consiguiendo-entrevistas/preparando-linkedin#linkedin-checklist"
  />
  <Cards.Card
    icon={<LinkIcon />}
    title="CV Checklist"
    href="/interview-ready/consiguiendo-entrevistas/preparando-el-cv#cv-checklist"
  />
  <Cards.Card
    icon={<LinkIcon />}
...
<Cards>
  <Cards.Card
    ...
    href="/interview-ready/recruiter-screening/trabajando-con-recruiters"
  />
  <Cards.Card
    icon={<LinkIcon />}
    title="Screening Call Checklist"
    href="/interview-ready/recruiter-screening/guia-de-screening#screening-call-checklist"
  />
</Cards>
...
href="/interview-ready/hiring-manager-screening/behavioral-preguntas-clasicas"
/>
<Cards.Card
icon={<LinkIcon />}
title="Behavioral II: Storytelling"
href="/interview-ready/hiring-manager-screening/behavioral-storytelling"
/>
...
<Cards.Card
  ...
  href="/interview-ready/hiring-manager-screening/behavioral-cultura-americana"
/>
...
### [Silver.dev] AI Adoption

AI Adoption es una entrevista de live coding con AI. Evalúa si podés usar agents para avanzar más rápido en un scope más grande pero sin dejar de entender el problema, comunicar decisiones, validar el resultado y administrar el tiempo.

La preparación base es la misma de cualquier live coding: resolver el problema correcto, mantener control sobre el código y probar constantemente. Lo adicional es llegar con tu setup listo: editor, terminal, agents, modelos, permisos y un plan para tomar control manual si la herramienta falla o se desvía.

Leé la guía específica de [AI Adoption](/interview-ready/entrevistas-silver-dev/ai-adoption) y el módulo de [AI Adoption](/interview-ready/ai-adoption/overview).
...
Mirá cómo luce un intento válido de esta entrevista en el siguiente video: [Javascript Connect4](https://docs.silver.dev/interview-ready/entrevistas-silver-dev/connect4). Encontrá el enunciado en nuestro [repo](https://github.com/silver-dev-org/interview-ready/blob/main/technical-fundamentals/coding/connect4.mjs).
...
### [Silver.dev] Live Coding Deliverables

A través de https://app.silver.dev tenés la posibilidad de demostrar tu progreso de manera async con videos simulando una live coding. Habilitamos esta oportunidad para que puedas tomar el feedback otorgado aplicando las correcciones recibidas en nuestra entrevista. La corrección se realiza por los mismos entrevistadores, y puede abrirte la puerta a más postulaciones de Silver.dev.

Encontrá todos nuestros enunciados en [el repo de interview ready](https://github.com/silver-dev-org/interview-ready/tree/main/misc/deliverables).
- [Sudoku](https://github.com/silver-dev-org/interview-ready/blob/main/misc/deliverables/sudoku.md)
- [Tetris](https://github.com/silver-dev-org/interview-ready/blob/main/misc/deliverables/tetris.md), [example](https://www.youtube.com/watch?v=M8fqHaJU_cc&t=2597s)
- [Silver.dev's 20 LeetCode Easy Challenge](https://github.com/silver-dev-org/interview-ready/blob/main/misc/deliverables/20-leetcode-easy.md)
- [Silver.dev's 10 Leetcode Medium Challenge](https://github.com/silver-dev-org/interview-ready/blob/main/misc/deliverables/10-leetcode-medium.md)
- [Tic Tac Toe](https://github.com/silver-dev-org/interview-ready/blob/main/misc/deliverables/tic-tac-toe.md)
- [Sign-up Form](https://github.com/silver-dev-org/interview-ready/blob/main/misc/deliverables/sign-up-form.md)
- [Connect4](https://github.com/silver-dev-org/interview-ready/blob/main/misc/deliverables/connect4.md)
...
<Cards>
  <Cards.Card
    ...
    href="/interview-ready/takehomes/guia-de-takehomes"
  />
</Cards>
...
<Cards>
  <Cards.Card
    ...
    href="/interview-ready/system-design-interviews/open-sea#guía-de-system-design"
  />
</Cards>
...
href="/interview-ready/manejando-ofertas/negociando-salarios"
/>
<Cards.Card
icon={<LinkIcon />}
