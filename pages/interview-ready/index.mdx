...
Vemos cómo entregar takehomes con buena calidad de código, y arrancamos con live coding y automated challenges para practicar bajo presión. También sumamos [AI-Fluent Live Coding](/interview-ready/ai-fluent-live-coding/interview-overview), el módulo específico para resolver live coding con agentes de AI.
...
<Cards>
  ...
  <Cards.Card
    icon={<CodeIcon />}
    title="AI-Fluent Live Coding"
    href="/interview-ready/ai-fluent-live-coding/interview-overview"
  />
  <Cards.Card
    icon={<ArrowRightIcon />}
    title="AI Adoption"
